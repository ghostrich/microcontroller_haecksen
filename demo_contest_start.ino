...
// 'planet', 30x22px
  0x00, 0xF0, 0x03, 0x0F, 0x00, 0xF0, 0x03, 0x0F, 0x00, 0x0F, 0xFC, 0x30, 
  0x00, 0x0F, 0xFC, 0x30, 0xC0, 0x00, 0xC3, 0x30, 0xC0, 0x00, 0xC3, 0x30, 
  0xC0, 0xF0, 0xC0, 0x0C, 0xC0, 0xF0, 0xC0, 0x0C, 0x30, 0x0F, 0x00, 0x03, 
  0x30, 0x0F, 0x00, 0x03, 0xF0, 0x00, 0x00, 0x03, 0xF0, 0x00, 0x00, 0x03, 
  0x30, 0x00, 0x00, 0x03, 0x30, 0x00, 0x00, 0x03, 0xCC, 0x00, 0xC0, 0x00, 
  0xCC, 0x00, 0xC0, 0x00, 0xC3, 0x00, 0xC0, 0x00, 0xC3, 0x00, 0xC0, 0x00, 
  0x03, 0x0F, 0x3C, 0x00, 0x03, 0x0F, 0x3C, 0x00, 0xFC, 0xF0, 0x03, 0x00, 
  0xFC, 0xF0, 0x03, 0x00, 
};
...
void loop() {
  ...
  display.clearDisplay();
  display.drawXBMP(0, 0, 30, 22, planet);
  display.sendBuffer();
  delay(3000);
